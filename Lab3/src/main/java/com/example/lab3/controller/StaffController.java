...
public class StaffController {
    ...
    public String list(Model model) {
        List<Staff> list = List.of(
                new Staff("user1@gmail.com","user1",0),
                new Staff("user2@gmail.com","user2",1),
                new Staff("user3@gmail.com","user3",2),
                new Staff("user4@gmail.com","user4",2),
                new Staff("user5@gmail.com","user5",1),
                new Staff("user6@gmail.com","user6",0)
        );
